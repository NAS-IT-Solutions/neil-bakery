            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 bg-black/35 px-3 py-2 rounded-full">
                {images.map((_, idx) => (
                    <button
                        ...
                        className={`w-2.5 h-2.5 rounded-full transition-all ${idx === active ? "bg-white scale-110" : "bg-white/60"
                            }`}
        ...
        () => [
            {
                ...
                images: [
                    "assets/images/Neil_Old_One.jpeg",
                    "assets/images/Neil_Old_Two.jpeg",
                ],
            },
            {
                year: "2005",
                ...
                image:
                    "assets/images/Father_photo.jpg",
            },
            {
                year: "2025",
                title: "Today & Beyond",
                ...
                images: [
                    "assets/images/Neil_Moratuwa.jpeg",
                    "assets/images/Neil_EgodaUyana.jpeg",
                ],
            },
        ],
        []
